...
import logging
import argparse
from Method2_vgg import vgg_model, vgg_dataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('-train_path', type=str, default="train", help='train images dir')
    parser.add_argument('-test_path', type=str, default="test", help='test images dir')
    ...
    parser.add_argument('-checkpoint_path', type=str, default="checkpoints", help='path to save model')
